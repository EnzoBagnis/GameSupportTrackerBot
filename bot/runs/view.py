...
class RunView(View):
    ...
    @discord.ui.button(label="Se désinscrire", style=discord.ButtonStyle.danger,
                       custom_id="btn_desinscrire", emoji="❌")
    ...
    async def fermer(self, interaction: discord.Interaction, button: Button):
        ...
        await send_recap(bot_client, run, interaction.guild)
...
class AlreadyInscritView(View):
    ...
    @discord.ui.button(label="Modifier mon inscription", style=discord.ButtonStyle.primary, emoji="✏️")
    ...
    @discord.ui.button(label="Déposer mes fichiers", style=discord.ButtonStyle.success, emoji="📎")
